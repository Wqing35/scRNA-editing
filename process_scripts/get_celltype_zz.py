...
def main():
    ...
    for one_sample in samples:
        for one_celltype in celltypes:
            ...
            zz_in_dir='/disk1/wenqing/tmp_data/ASD/ctr_male_pfc/AEI/'+one_sample+'/regular_combined.zz'
            geneWzRes_ad_in_dir='/disk1/wenqing/tmp_data/ASD/ctr_male_pfc/ctr_'+one_sample+'/'+one_celltype+'_geneWithRegular_res_over1.txt'
            zz_out_dir='/disk1/wenqing/tmp_data/ASD/ctr_male_pfc/AEI/'+one_sample+'/'+'celltype_AEI/'+one_celltype+'/regular_combined.zz'
