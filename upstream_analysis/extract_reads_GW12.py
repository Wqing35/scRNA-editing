...
for celltype in celltypes:
    barcode_file = "/disk1/wenqing/tmp_data/PFC_s2/20240425_use/GW12/"+celltype+"_barcode.txt"
    read1_file = "/disk1/wenqing/tmp_data/PFC_s2/all_fastq/SRR6367161_1.fastq"  
    read2_file = "/disk1/wenqing/tmp_data/PFC_s2/all_fastq/SRR6367161_2.fastq"  
    output_read1 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW12/"+celltype+"_read1.fastq"  
    output_read2 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW12/"+celltype+"_read2.fastq"  
