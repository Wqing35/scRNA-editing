...
#GW19_sample=['SRR6367172','SRR6367173','SRR6367174']
GW19_sample=['SRR6367174']
#celltypes = ['GABAergic_neurons','Stem_cell','Neurons','OPC']
celltypes = ['GABAergic_neurons','Neurons','OPC']
i=3
for one in GW19_sample:
    ...
    for celltype in celltypes:
        barcode_file = "/disk1/wenqing/tmp_data/PFC_s2/20240425_use/GW19_1_"+str(i)+"/"+celltype+"_barcode.txt"
        output_read1 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW19_1_"+str(i)+"/"+celltype+"_read1.fastq"  
        output_read2 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW19_1_"+str(i)+"/"+celltype+"_read2.fastq"  
        #print(barcode_file+'\n'+read1_file+'\n'+read2_file+'\n'+output_read1+'\n'+output_read2)
