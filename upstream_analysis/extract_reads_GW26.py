...
# 使用示例
#GW26_sample=['SRR6367179','SRR6367180','SRR6367181','SRR6367182','SRR6367183','SRR6367184','SRR6367185','SRR6367186','SRR6367187','SRR6367178']
GW26_sample=['SRR6367186','SRR6367187','SRR6367178']
celltypes = ['GABAergic_neurons','Neurons','OPC']
i=8
for one in GW26_sample:
    ...
    for celltype in celltypes:
        barcode_file = "/disk1/wenqing/tmp_data/PFC_s2/20240425_use/GW26_1_"+str(i)+"/"+celltype+"_barcode.txt"
        output_read1 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW26_1_"+str(i)+"/"+celltype+"_read1.fastq"  
        output_read2 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW26_1_"+str(i)+"/"+celltype+"_read2.fastq"  
        #print(barcode_file+'\n'+read1_file+'\n'+read2_file+'\n'+output_read1+'\n'+output_read2)
