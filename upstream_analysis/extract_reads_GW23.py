...
# 使用示例
GW23_sample=['SRR6367175','SRR6367176','SRR6367177']
celltypes = ['Neurons','OPC','GABAergic_neurons']
i=1
for one in GW23_sample:
    ...
    for celltype in celltypes:
        barcode_file = "/disk1/wenqing/tmp_data/PFC_s2/20240425_use/GW23_1_"+str(i)+"/"+celltype+"_barcode.txt"
        output_read1 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW23_1_"+str(i)+"/"+celltype+"_read1.fastq"  
        output_read2 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW23_1_"+str(i)+"/"+celltype+"_read2.fastq"  
        #print(barcode_file+'\n'+read1_file+'\n'+read2_file+'\n'+output_read1+'\n'+output_read2)
