...
# 使用示例
celltypes = ['GABAergic_neurons','Stem_cell','Neurons']
for celltype in celltypes:
    barcode_file = "/disk1/wenqing/tmp_data/PFC_s2/20240425_use/GW10_2_2/"+celltype+"_barcode.txt"
    read1_file = "/disk1/wenqing/tmp_data/PFC_s2/SRR6367159/SRR6367159_1.fastq"  
    read2_file = "/disk1/wenqing/tmp_data/PFC_s2/SRR6367159/SRR6367159_2.fastq"  
    output_read1 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW10_2_2/"+celltype+"_read1.fastq"  
    output_read2 = "/disk1/wenqing/tmp_data/PFC_s2/data/GW10_2_2/"+celltype+"_read2.fastq"  
